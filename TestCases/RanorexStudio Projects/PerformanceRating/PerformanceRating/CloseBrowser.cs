...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("0a33dab8-01a2-4f5b-bee7-6ab832f37d4b", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'GoogleGoogleChrome'.", repo.GoogleGoogleChrome.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.GoogleGoogleChrome.Self, new Duration(0));

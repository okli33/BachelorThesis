describe('test_name', function() {
    ...
    it('what_it_does', function() {
       ...
       cy.get('.justify-content-center > .col-md-8 > #register-form > .form-group > #email').click()
    
       cy.get('.justify-content-center > .col-md-8 > #register-form > .form-group > #email').type('user1@mail.com')
    
       cy.get('.justify-content-center > .col-md-8 > #register-form > .form-group > #firstPassword').click()
    
       cy.get('.justify-content-center > .col-md-8 > #register-form > .form-group > #firstPassword').type('user1')
    
       cy.get('.justify-content-center > .col-md-8 > #register-form > .form-group > #secondPassword').click()
    
       cy.get('.justify-content-center > .col-md-8 > #register-form > .form-group > #secondPassword').type('user')
    
       cy.get('.view-routes > div > .justify-content-center > .col-md-8 > #register-form').click()
